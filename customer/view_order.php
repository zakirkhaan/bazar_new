                                ...
                                <?php if ($vendor_order_status == "processing" or $vendor_order_status == "completed") { ?>
                                    ...
                                    <form method="post" action="write_review.php" class="write-review-form">
                                      ...
                                      <?php if ($count_vendor_orders > 1) { ?>
                                          ...
                                          <input type="hidden" name="sub_order_id"
                                                 value="<?php echo $vendor_order_id; ?>">
                ...
                if ($count_vendor_orders > 1) {
                  ...
                  ?>
                    ...
                    <div class="alert alert-info">
                        ...
                        into multiple vendor orders. Each order will be handled by their respective vendor
                        independently.
                            ...
                            <tr><!-- tr Starts -->
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-success btn-sm"
                                       href="view_order.php?order_id=<?php echo $order_id; ?>&sub_order_id=<?php echo $sub_order_id; ?>">
                          ...
                          ?>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    ...
                                    If Your Order Status be Processing/Completed You will be able to access order
                                    downloads.
                          ...
                          ?>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    ...
                                    If Your Vendor Order Status be Processing/Completed You will be able to access order
                                    downloads.
