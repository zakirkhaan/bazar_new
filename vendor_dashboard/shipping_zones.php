    ...
    <div class="col-lg-12"><!-- col-lg-12 Starts -->
        <div class="panel panel-default"><!-- panel panel-default Starts -->
            ...
            <div class="panel-body"><!-- panel-body Starts -->
                ...
                A shipping zone is a geographic region where a certain set of shipping types are offered. System will
                match a customer to a single zone using their shipping address and present the shipping types within
                that zone to them.
                <br><br>
