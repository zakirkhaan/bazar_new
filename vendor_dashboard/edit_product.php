                        ...
                        <div class="form-group row"><!-- form-group Starts -->
                            ...
                            <div class="col-sm-10"><!-- col-sm-10 Starts -->
                                ...
                                <select class="form-control" id="action_select"><!-- select manufacturer Starts -->
                                    ...
                                    <option value="create_variations_from_attributes"> Create New Variations From All
                                        Attributes
                                    </option>
...
<div class="form-group"><!-- form-group Starts -->
    ...
    <input type="submit" name="update" value="Update Product" form="edit_product_form"
...
if (isset($_POST['update'])) {
  ...
  if ($run_product) {
    ...
    echo "<script>alert(' Your Product Has Been updated Successfully. ');window.open('index.php?products','_self');</script>";
