                    ...
                    <div class="row"><!-- 2 row Starts -->
                        <div class="col-md-9"><!-- col-md-9 Starts -->
                                ...
                                <div class="tab-content"><!-- tab-content Starts -->
                                    <div id="description" class="tab-pane fade in active">
                                        ...
                                        <textarea name="product_desc" class="form-control" rows="15"
                                                  id="product_desc"><?php echo $p_desc; ?></textarea>
                                    ...
                                    <div id="features" class="tab-pane fade in">
                                        ...
                                        <textarea name="product_features" class="form-control" rows="15"
                                                  id="product_features"><?php echo $p_features; ?></textarea>
                                    ...
                                    <div id="video" class="tab-pane fade in"><!-- video tab-pane fade in Starts -->
                                        ...
                                        <textarea name="product_video" class="form-control"
                                                  rows="15"><?php echo $p_video; ?></textarea>
                            ...
                            <div class="form-group"><!-- form-group Starts -->
                                ...
                                <select data-placeholder="Select Bundle Products" name="bundle_products[]"
                        ...
                        <div class="col-md-3"><!-- col-md-3 Starts -->
                            ...
                            <div class="form-group"><!-- form-group Starts -->
                                ...
                                <select class="form-control" name="product_type"><!-- select manufacturer Starts -->
                                  ...
                                  <?php if ($p_type == "physical_product") { ?>
                                      ...
                                      <option value="physical_product" selected> (Physical Product) Simple Bundle
                                      </option>
                                  ...
                                  <?php } elseif ($p_type == "digital_product") { ?>
                                      ...
                                      <option value="digital_product" selected> (Digital Product) Downloadable Bundle
                                      </option>
                                  ...
                                  <?php } elseif ($p_type == "variable_product") { ?>
                                      ...
                                      <option value="variable_product" selected> (Variable Product) Advanced Bundle
                                      </option>
                            ...
                            <div class="form-group"><!-- form-group Starts -->
                              ...
                              <?php } else { ?>
                                  ...
                                  <img src="../admin_area/product_images/<?php echo $p_image2; ?>" width="70"
                                       height="70">
                            ...
                            <div class="form-group"><!-- form-group Starts -->
                              ...
                              <?php } else { ?>
                                  ...
                                  <img src="../admin_area/product_images/<?php echo $p_image3; ?>" width="70"
                                       height="70">
                                        ...
                                        <div class="form-group"><!-- form-group Starts -->
                                            ...
                                            <div class="radio">
                                                ...
                                                <label>
                                                    ...
                                                    <input type="radio" name="enable_stock"
                                ...
                                <div id="product_attributes" class="tab-pane fade in active">
                                    ...
                                    <form id="insert_attribute_form" method="post"><!-- form Starts -->
                                        ...
                                        <div class="form-group"><!-- form-group Starts -->
                                            ...
                                            <input type="submit" value="Insert Bundle Attribute"
...
These are the Bundle attributes that will be pre-selected on the frontend.
                                        ...
                                        <div class="form-group"><!-- form-group Starts -->
                                            ...
                                            <input type="submit" value="Save Bundle Variations"
                ...
                <div class="form-group"><!-- form-group Starts -->
                    ...
                    <input type="submit" name="update" value="Update Bundle" form="edit_product_form"
