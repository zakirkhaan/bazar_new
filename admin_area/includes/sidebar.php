            ...
            <ul class="nav navbar-nav side-nav"><!-- nav navbar-nav side-nav Starts -->
                ...
                <li><!-- Icons Li Starts -->
                    ...
                    <a href="#" data-toggle="collapse" data-target="#shipping_zones">
                        ...
                        <i class="fa fa-truck" aria-hidden="true"></i> Bazar Shipping
                ...
                <li><!-- Icons Li Starts -->
                    ...
                    <a href="#" data-toggle="collapse" data-target="#countries">
                        ...
                        <i class="fa fa-globe" aria-hidden="true"></i> Cities
                    ...
                    <ul id="countries" class="collapse"><!-- Icons Ul Starts -->
                        ...
                        <li>
                            <a href="index.php?insert_country"> Insert City </a>
                        </li>

                        <li>
                            <a href="index.php?view_countries"> View Cities </a>
                        </li>
