                                ...
                                <div class="form-group"><!-- form-group Starts -->
                                    ...
                                    <select class="form-control" name="product_type"><!-- select manufacturer Starts -->
                                      <?php if ($p_type == "physical_product") { ?>
                                          ...
                                          <option value="digital_product"> (Digital Product) Downloadable Bundle
                                          </option>
                                        ...
                                        <div class="col-sm-6"><!-- col-sm-6 Starts -->
                                            ...
                                            <div class="form-group"><!-- form-group Starts -->
                                                ...
                                                <input type="number" name="stock_quantity"
                                                       value="<?php echo $stock_quantity; ?>" class="form-control"
                                                       required>
                                            ...
                                            <div class="form-group"><!-- form-group Starts -->
                                                ...
                                                <select class="form-control" name="allow_backorders" required>
                                                  ...
                                                  <?php } elseif ($allow_backorders == "notify") { ?>
                                                      ...
                                                      <option value="notify" selected>Allow, but notify customer
                                                      </option>
