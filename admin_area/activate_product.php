...
<script>alert(' One Product Has Been Activated Successfully And is Live To Website. ');window.open('index.php?view_products','_self');</script>";
      } elseif (isset($_GET['bundles'])) {
        echo "<script>alert(' One Bundle Has Been Activated Successfully And is Live To Website. ');window.open('index.php?view_bundles','_self');</script>";
      }
    }
  }
  ?>
