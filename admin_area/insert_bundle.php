                                        ...
                                        <div class="col-sm-6"><!-- col-sm-6 Starts -->
                                            ...
                                            <div class="form-group"><!-- form-group Starts -->
                                                ...
                                                <div class="radio">
                                                    ...
                                                    <label>
                                                        <input type="radio" name="enable_stock" value="yes" required>
                                                        Yes
                                                    </label>

                                                    <label>
                                                        <input type="radio" name="enable_stock" value="no" checked
                                                               required> No
                                                    </label>
...
These are the Bundle attributes that will be pre-selected on the frontend.
                    ...
                    <div class="form-group"><!-- form-group Starts -->
                        ...
                        <input type="submit" name="submit" value="Insert Bundle" form="insert_product_form"
