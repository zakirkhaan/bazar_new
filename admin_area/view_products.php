                        ...
                        <div class="row"><!-- row Starts -->
                          ...
                          <?php if (isset($_REQUEST["product_status"])) { ?>
                              ...
                              <input type="hidden" name="product_status"
                                     value="<?php echo $_REQUEST["product_status"]; ?>">
        ...
        <div class="col-lg-12"><!-- col-lg-12 Starts -->
            ...
            <div class="panel panel-default"><!-- panel panel-default Starts -->
                ...
                <div class="panel-body"><!-- panel-body Starts -->
                    ...
                    <a href="index.php?view_products=1&product_status=all<?php echo $filter_url; ?>"
                    ...
                    <a href="index.php?view_products=1&product_status=active<?php echo $filter_url; ?>"
                    ...
                    <a href="index.php?view_products=1&product_status=pending<?php echo $filter_url; ?>"
                    ...
                    <a href="index.php?view_products=1&product_status=paused<?php echo $filter_url; ?>"
                       class="link-separator <?php echo_active_class("paused"); ?>">
                    ...
                    <a href="index.php?view_products=1&product_status=trash<?php echo $filter_url; ?>"
