<?php
//defining the type of review and the review order//
//if its not defined send him back to checkout.php page//
if(!defined("review_order")){
    echo "<script> window.open('checkout.php','_self'); </script>";
}
//secting everything from payment//
//i have already integrated paypal and stripe with bazaar for demonstration purpose just to check whether our site
//can handle online payments or not//
//in case of error i need to go back and see the api integration video of Paypal in youtube.
...
<div class="row"><!--- row Starts -->
  <?php
  //getrealuserip function is added in functions.php page//
                  ...
                  <tr>
                      ...
                      <th colspan="2">
                          ...
                          <input id="offline" type="radio" name="payment_method" value="pay_offline"
                            ...
                            <?php if ($enable_paypal == "no" and $enable_stripe == "no") {
                              echo "checked";
                            } ?>>
                      ...
                      <tr>
                          ...
                          <th colspan="2">
                              ...
                              <input id="stripe" type="radio" name="payment_method" value="stripe"
                                ...
                                <?php if ($enable_paypal == "no") {
                                  echo "checked";
                                } ?> >

                              <label for="stripe">Credit Card (Stripe)</label>

                              <p id="stripe_desc" class="text-muted">Pay with your credit card via Stripe.
                                  <!--                                  TEST MODE ENABLED. In test mode, you can use the-->
<!--                                  card number 4242424242424242 with any CVC and a valid expiration date or check the-->
<!--                                  documentation "Testing Stripe" for more card numbers.-->
                              </p>
                      ...
                      <td id="payment-forms-td" colspan="2">
                          ...
                          <form id="offline_form" action="order.php" method="post"><!-- offline Payment form Starts -->
                            ...
                            <?php } ?>
                              ...
                              <input type="submit" id="offline-submit" name="submit" value="Place Order"
                        ...
                        if ($enable_stripe == "yes") {
                          ...
                          ?>
                            ...
                            <form id="stripe_form" action="stripe_charge.php" method="post">
                                ...
                                <input type="hidden" name="stripe_total_amount"
                                       value="<?php echo $stripe_total_amount; ?>">
                            ...
                            <form id="paypal_form" action="<?php echo $paypal_url; ?>" method="post">
                              ...
                              <?php if (count($physical_products) > 0) { ?>
                                  ...
                                  <input type="hidden" name="return"
                                         value="http://localhost/new_updated_ecom/paypal_order.php?c_id=<?php echo $customer_id; ?>&amount=<?php echo $total_cart_price; ?>">

                              <?php } else { ?>

                                  <input type="hidden" name="return"
                                         value="http://localhost/new_updated_ecom/paypal_order.php?c_id=<?php echo $customer_id; ?>&amount=<?php echo $total; ?>">

                              <?php } ?>

                                <input type="hidden" name="cancel_return"
                                       value="http://localhost/new_updated_ecom/checkout.php">
          ...
          <?php } } ?>
            ...
            $.ajax({
                ...
                .done(function (data) {
                    ...
                    $(".total-shipping-price").html("Rs:" + total_cart_price + ".00");
